...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
 args = cms.vstring('/afs/cern.ch/user/c/covarell/work/zzpol/genproductions/bin/MadGraph5_aMCatNLO/test/ZZTo4L_LL_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
